...
export async function createSubshardedDirectory(blockstore, depth = 1, files = 5000) {
    ...
    const importResult = await last(importer(new Array(count).fill(0).map((_, i) => {
        return {
...
async function searchCIDForSubshards(cid, blockstore, depth = 1) {
...
//# sourceMappingURL=create-subsharded-directory.js.map